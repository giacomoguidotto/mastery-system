...
| CAP-10 | Build useful models of unfamiliar vertical domains such as ERP, fintech, healthcare, insurance, or voice AI | Supporting | Select per real customer or product opportunity | Not assessed | — |

Candidate labs are hypotheses, not curriculum obligations. Activate one only when a real product seam can produce relevant evidence and the project has installed the agent trigger defined in `PROGRAM.md`.
